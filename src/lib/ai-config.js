...
export const getMockResponses = () => {
  ...
  memoizedMockResponses = {
    welcome: {
      type: 'assistant',
      content:
        "Hello! I'm your Career Match AI assistant. I'm here to help you with resume building, interview preparation, and career guidance. What would you like to work on today?",
