...
const Header = ({ user }) => {
  ...
  const renderSignOutDropdown = () => (
    <div className={`rounded-md overflow-hidden ${darkMode ? 'bg-gray-900' : 'bg-white'} 
  ...
  return (
    ...
    >
                ...
                <div className="flex items-center cursor-pointer hover:opacity-80 transition-opacity py-1 md:py-2 px-2 md:px-3 rounded-full hover:bg-white/10 dark:hover:bg-black/20">
                  ...
                  >
                    {user.ExtraData?.LargeProfilePicURL ? (
                      <img 
                        src={user.ExtraData.LargeProfilePicURL} 
                        alt={user.Username}
      ...
      >
        <p style={{ color: darkMode ? '#e5e7eb' : '#374151', margin: 0 }}>
