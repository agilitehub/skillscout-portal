...
const skillScoutTailwindPlugin = require('./tailwindPlugin')

/**
 * Core Tailwind configuration for Skill Scout design system.
 * Semantic colors live in tokens.css; component styles in tailwindPlugin.js.
 */
module.exports = {
  theme: {
    extend: {
  ...
  plugins: [skillScoutTailwindPlugin]
}
