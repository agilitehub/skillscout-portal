  ...
  return (
    <div className='w-full max-w-lg mx-auto mt-6 mb-4 z-20 relative'>
      <div
        ...
        style={{
          background: darkMode ? 'rgba(10, 25, 41, 0.8)' : 'rgba(255, 255, 255, 0.9)',
          backdropFilter: 'blur(12px)',
          border: `1px solid ${darkMode ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.05)'}`,
          boxShadow: darkMode ? '0 8px 32px rgba(0, 0, 0, 0.3)' : '0 8px 32px rgba(13, 32, 53, 0.15)'
        }}
      >
        <div className='text-center'>
          <div className='mb-2'>
            <span className='text-3xl md:text-4xl animate-bounce inline-block' style={{ animationDuration: '2s' }}>
              🚀
            </span>
          </div>
          <Title
            ...
            style={{
              color: darkMode ? BRAND_COLORS.white : colors.logoNavy,
