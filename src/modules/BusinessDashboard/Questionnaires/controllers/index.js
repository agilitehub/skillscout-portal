...
import { QUESTIONNAIRE_STATUS, QUESTIONNAIRE_STATUS_LIST } from '../../../../constants'
import { transformToDatabase, transformFromDatabase, validateQuestionnaire } from '../model'
...
export const duplicateQuestionnaire = async (id, overrides = {}) => {
  try {
    ...
    if (originalData.questions && originalData.questions.length > 0) {
      const { createQuestionnaireQuestion } = await import('./questions')
