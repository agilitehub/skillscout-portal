            ...
            <div className='flex items-center space-x-4'>
              ...
              >
                <Button 
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = darkMode ? DARK_THEME.background.tertiary : LIGHT_THEME.background.tertiary
                    e.currentTarget.style.borderColor = SEMANTIC_COLORS.primary
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = 'transparent'
                    e.currentTarget.style.borderColor = darkMode ? DARK_THEME.border.secondary : LIGHT_THEME.border.secondary
                  }}
              ...
              <Col xs={24} md={8}>
                ...
                >
                  <Statistic
                    ...
                    value={3}
                    prefix={<FontAwesomeIcon icon={faUserPlus} style={{ color: SEMANTIC_COLORS.success, fontSize: '18px' }} />}
                    valueStyle={{ 
                      color: darkMode ? DARK_THEME.text.primary : LIGHT_THEME.text.primary, 
                      fontSize: '28px' 
                    }}
              ...
              <Col xs={24} md={8}>
                ...
                >
                  <Statistic
                    ...
                    value={7}
                    prefix={<FontAwesomeIcon icon={faSearch} style={{ color: SEMANTIC_COLORS.primary, fontSize: '18px' }} />}
                    valueStyle={{ 
                      color: darkMode ? DARK_THEME.text.primary : LIGHT_THEME.text.primary, 
                      fontSize: '28px' 
                    }}
              ...
              <Col xs={24} md={8}>
                ...
                >
                  <Statistic
                    ...
                    value={2}
                    prefix={<FontAwesomeIcon icon={faChartLine} style={{ color: SEMANTIC_COLORS.warning, fontSize: '18px' }} />}
                    valueStyle={{ 
                      color: darkMode ? DARK_THEME.text.primary : LIGHT_THEME.text.primary, 
                      fontSize: '28px' 
                    }}
                ...
                <List.Item
                  ...
                  style={{
                    ...
                    backgroundColor: !alert.read 
                      ? darkMode ? 'rgba(74, 144, 164, 0.1)' : 'rgba(74, 144, 164, 0.05)'
                      : darkMode ? DARK_THEME.background.secondary : LIGHT_THEME.background.primary
                  }}
                >
                  <List.Item.Meta
                                         avatar={
            ...
            <div className='text-center py-8'>
              <div
                style={{
                  ...
                  borderRadius: '50%',
                  backgroundColor: darkMode 
                    ? `${SEMANTIC_COLORS.primary}15` 
                    : `${SEMANTIC_COLORS.primary}10`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
